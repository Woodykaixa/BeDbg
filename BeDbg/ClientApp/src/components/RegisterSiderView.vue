...
<template>
  ...
  />
  <n-divider> EFlags 标志寄存器: {{ DataFormatter.formatNumberHex(props.registers.eFlags, 8) }} </n-divider>
  <n-data-table
    :border="false"
    :columns="[
      { title: '名称', key: 'name1' },
  ...
  />
  <n-divider> FPU TagWord: {{ DataFormatter.formatNumberHex(props.registers.fpuTagWord, 4) }} </n-divider>
  <n-data-table
    :bordered="false"
    :columns="[
      { title: '名称', key: 'name1' },
  ...
  />
  <n-divider> FPU 状态寄存器: {{ DataFormatter.formatNumberHex(props.registers.fpuStatusWord, 4) }} </n-divider>
  <n-data-table
    :bordered="false"
    :columns="[
      { title: '名称', key: 'name1' },
  ...
  />
  <n-divider> FPU 控制寄存器: {{ DataFormatter.formatNumberHex(props.registers.fpuControlWord, 4) }} </n-divider>
  <n-data-table
    :bordered="false"
    :columns="[
      { title: '名称', key: 'name1' },
  ...
  />
  <n-divider> MxCsr 标志寄存器: {{ DataFormatter.formatNumberHex(props.registers.mxCsr) }} </n-divider>
  <n-data-table
    :bordered="false"
    :columns="[
      { title: '名称', key: 'name1' },
